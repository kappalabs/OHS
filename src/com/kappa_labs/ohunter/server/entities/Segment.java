...
public class Segment {
    ...
    /**
     * Count the segments from given MyImage, which did go through the
     * segmentation algorithm and the means, which is the output of the
     * segmentation.
     *
    ...
    public static Segment[] makeSegments(MyImage img, Pixel[] means) {
        ...
        /**
         * Count the other two moments, number of pixels in the segment and the
         * rectangle borders.
         */
