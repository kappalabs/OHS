...
public class Segmenter {
    ...
    public static Segment[] segment(Photo photo) {
        ...
        try {
            ...
            nsDir.mkdirs();
            ImageIO.write(((SImage)photo.sImage).toBufferedImage(), "jpg", new File(nsDir + "/" + (a) + "_" + photo.generateName(64) + ".jpg"));
        ...
        try {
            ...
            sDir.mkdirs();
            ImageIO.write(nbi, "jpg", new File(sDir + "/" + (a++) + "_" + photo.generateName(64) + ".jpg"));
        } catch (IOException ex) { }
